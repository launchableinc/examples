...
echo "# Command: launchable subset --target 50% --build \"\$BUILD_NAME\" gradle src/test/java > subset.txt"
launchable subset --target 50% --build "$BUILD_NAME" gradle src/test/java > subset.txt
